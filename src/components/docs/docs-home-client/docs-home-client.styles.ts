export const docsHomeClientStyles = {
  ...
  categoryCard:
    "block p-6 bg-muted rounded-lg hover:bg-accent transition-colors",
  ...
  documentCard:
    "block p-6 border border-border rounded-lg hover:border-primary/50 hover:shadow-sm transition-all",
  documentContent: "flex items-start justify-between",
  documentInfo: "flex-1 min-w-0",
  documentTitle:
    "text-lg font-semibold text-foreground mb-2 group-hover:text-primary transition-colors",
