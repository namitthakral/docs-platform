export const tagSkeletonStyles = {
  ...
  tagName: 'h-4 bg-gray-200 rounded animate-pulse w-20',
  tagUsage: 'h-3 bg-gray-200 rounded animate-pulse w-16',
  tagActions: 'flex items-center gap-2 ml-4',
  actionButton: 'w-8 h-8 bg-gray-200 rounded animate-pulse',
}