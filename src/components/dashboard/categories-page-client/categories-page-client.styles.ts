export const categoriesPageClientStyles = {
  ...
  addButton: "inline-flex items-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition-colors cursor-pointer",
  addIcon: "w-4 h-4",
  
  // Mobile header
  mobileHeader: "md:hidden space-y-4",
  mobileHeaderContent: "",
  mobileAddButton: "w-full inline-flex items-center justify-center gap-2 bg-blue-600 text-white px-4 py-3 rounded-md hover:bg-blue-700 transition-colors cursor-pointer",
